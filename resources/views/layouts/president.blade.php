            ...
            <div class="app-header header sticky">
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="{{ url('president/dashboard') }}">
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <a class="dropdown-item" href="{{ url('president/profile') }}" >
            ...
            <div class="sticky">
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="{{ url('president/dashboard') }}">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('president/dashboard') }}"><i class="side-menu__icon fa fa-bar-chart"></i><span class="side-menu__label">Dashboard</span></a>
                            </li>
                            <li class="slide">
