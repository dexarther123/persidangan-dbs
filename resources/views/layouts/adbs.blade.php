                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('adbs/pilih-usul') }}"><i class="side-menu__icon fa fa-align-justify"></i><span class="side-menu__label">Senarai Usul</span></a>
                            </li>
							<li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('adbs/undi') }}"><i class="side-menu__icon fa fa-check"></i><span class="side-menu__label">Senarai Undi Persidangan</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('adbs/profil') }}"><i class="side-menu__icon fa fa-user"></i><span class="side-menu__label">Profil</span></a>
                            </li>		
                            <li class="slide">
